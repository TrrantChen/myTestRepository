...
define(["common"], function(common) {
    ...
    function postJsonWithContentype() {
    ...
    function postJsonWithoutContentype() {
        var xhr = new XMLHttpRequest();
    ...
    function postMulFormFormData(parseType) {
        var xhr = new XMLHttpRequest();
        var formData = new FormData();
        switch (parseType) {
            case "multiparty":
    ...
    return {
        postJsonWithContentype: postJsonWithContentype,
        postJsonWithoutContentype: postJsonWithoutContentype,
        formPost: formPost,
        postText:postText,
        postMulFormText:postMulFormText,
        postMulFormFormData:postMulFormFormData,
        postXml:postXml
    }
})