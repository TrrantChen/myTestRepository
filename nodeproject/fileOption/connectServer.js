...
exports.functionRoute = function(app) {
    commonProcess.preProcessHttpMethods("get", "/", defaultConnect);
    commonProcess.preProcessHttpMethods("get", "/testUrlAndpath", testUrlAndpath);
    commonProcess.preProcessHttpMethods("get", "/serverPathTest", serverPathTest);
    commonProcess.preProcessHttpMethods("get", "/xhr2crossdomain", xhr2crossdomain);
    commonProcess.preProcessHttpMethods("get", "/test4Jsonp", test4Jsonp);   
    commonProcess.preProcessHttpMethods("get", "/getClientIPAdress", getClientIPAdress);  
    commonProcess.preProcessHttpMethods("get", "/delayloadtest", delayloadtestGet); 
    commonProcess.preProcessHttpMethods("post", "/delayloadtest", delayloadtestPost, jsonParser);
    commonProcess.preProcessHttpMethods("get", "/getArrayResut", getArrayResut);
}
