...
RSAKey.prototype.encrypt = RSAEncrypt;/*閫氱敤RSA鍔犲瘑*/
RSAKey.prototype.encryptPama = RSAEncryptPama;/*PAMA RSA鍔犲瘑*/
RSAKey.prototype.encryptBank = RSAEncryptBank;/*閾惰RSA鍔犲瘑*/
...
function b64tohex(s) {
    ...
    for(i = 0; i < s.length; ++i) {
        ...
        v = b64map.indexOf(s.charAt(i)); //NOSONAR
        if(v < 0) continue;
        if(k == 0) {
            ret += int2char(v >> 2);
            slop = v & 3;
