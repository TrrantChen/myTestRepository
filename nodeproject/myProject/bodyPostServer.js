...
exports.functionRoute = function(app) {
    commonProcess.preProcessHttpMethods("post", "/sendJsonWithoutContentype", parseJsonWithoutContentType);
    commonProcess.preProcessHttpMethods("post", "/sendJsonClientCROS", parseJsonCROSPost, jsonParser);
    commonProcess.preProcessHttpMethods("post", "/sendTextClient", parseText, txtParser);
    commonProcess.preProcessHttpMethods("post", "/sendFormClient", urlencodedParser, parseForm);
    commonProcess.preProcessHttpMethods("post", "/sendFormDataParseByConnectMultiparty", parseFormDataByConnectMultiparty, multipartMiddleware);
    commonProcess.preProcessHttpMethods("post", "/sendFormDataParseByBusboy", parseFormDataByBusboy);
    commonProcess.preProcessHttpMethods("post", "/sendFormDataParseByMultiparty", parseFormDataByMultiparty);
    commonProcess.preProcessHttpMethods("post", "/upLoadFileByConnectMultiparty", parseFileByConnectMultiparty);
    commonProcess.preProcessHttpMethods("post", "/upLoadFileByMultiparty", parseFileByMultiparty);
    commonProcess.preProcessHttpMethods("post", "/upLoadFileByBusboy", parseFileByBusboy);
    commonProcess.preProcessHttpMethods("get", "/downLoadFileWithBuffer", downLoadFileWithBuffer);
    commonProcess.preProcessHttpMethods("get", "/downLoadFileWithStream", downLoadFileWithStream);
}
