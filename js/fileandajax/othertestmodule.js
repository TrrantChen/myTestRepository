...
define(["common"], function(common) {
    ...
    function verifyTheNormalAjaxResult(connectType, url) {
    ...
    function promiseResult(connectType, url, delay) {
    ...
    return {
        ...
        verifyTheNormalAjaxResult:verifyTheNormalAjaxResult,
