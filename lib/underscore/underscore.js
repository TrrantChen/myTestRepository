...
(function() {
  ...
  // Function (ahem) Functions
    ...
    // reading 策略，一开始执行函数，在wait的时间段内不响应函数的执行，
    // wait时间段过后再响应函数执行，函数执行后，会空置一段wait,在空置wait过完会执行一次函数
    ...
    // reading 将两个函数混合起来，并将最后一个函数的执行结果作为前面所有函数的入参
